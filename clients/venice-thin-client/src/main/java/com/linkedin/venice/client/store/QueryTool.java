...
public class QueryTool {
  ...
  public static void main(String[] args) throws Exception {
    ...
    System.out.println("DEBUG: facetCountingMode = " + facetCountingMode);
    System.out.println("DEBUG: countByValueFields = " + countByValueFields);
    System.out.println("DEBUG: topK = " + topK);
